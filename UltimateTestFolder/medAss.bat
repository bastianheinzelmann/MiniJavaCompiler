...
gcc -m32 -o BinarySearch BinarySearch.s runtime.c
gcc -m32 -o BubbleSort BubbleSort.s runtime.c
gcc -m32 -o BinaryTree BinaryTree.s runtime.c
gcc -m32 -o Euler Euler.s runtime.c
gcc -m32 -o Fannkuch Fannkuch.s runtime.c
gcc -m32 -o Fib Fib.s runtime.c
gcc -m32 -o FibL FibL.s runtime.c
gcc -m32 -o Graph Graph.s runtime.c
gcc -m32 -o Hanoi Hanoi.s runtime.c
gcc -m32 -o LinearSearch LinearSearch.s runtime.c
gcc -m32 -o LinkedList LinkedList.s runtime.c
gcc -m32 -o ManyArgs ManyArgs.s runtime.c
gcc -m32 -o Newton Newton.s runtime.c
gcc -m32 -o PiSin PiSin.s runtime.c
gcc -m32 -o Primes Primes.s runtime.c
gcc -m32 -o QuickSort QuickSort.s runtime.c
